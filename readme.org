...
** Development and Testing
   ...
   Has been used GNU Emacs (the only true operating system), clang compiler
   (LLVM) 3.8.0, konsole and fish, running in Freidora 24.

   - *NOTE* :: in fedora 24 with gcc 6.1.1 two strangers errors occur in the
               =ascii_test.c= test file, lines 180 and 181.
