...
* Introduccion
  ...
  *Recurseve Regexp Raptor* es una libreria de busqueda, captura y reemplazo de
  ...
  Existen dos desarrollos paralelos de esta libreria es primero (el presente) se
  ...
  de C tal cual la primer vercion ocupa un total de *532 lineas de codigo* y la
  segunda *687 lineas*. enjoy!
